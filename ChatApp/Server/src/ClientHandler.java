...
//    }
    ...
    private void handleMessage(String[] tokens) throws IOException {
        ...
        System.out.println("Message to [ " + sendTo +" ]: " + body);
    ...
    private void handleLogin(OutputStream outputStream, String[] tokens) throws IOException {
        if (tokens.length == 3) {
            ...
            try {
                ...
                PreparedStatement pstmt = connection.prepareStatement("select username, password from users where username = ? and password = aes_encrypt(?,'key5432155555')");

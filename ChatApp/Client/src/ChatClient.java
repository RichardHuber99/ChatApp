...
//    }
    ...
    public void msg(String sendTo, String msgBody) throws Exception {
        String cmd = "msg " + sendTo + " " + AESenc.encrypt(msgBody) + "\n";
        serverOut.write(cmd.getBytes());
    }

    //apelata in LoginWindow, trimitem comanda de login la server si asteptam raspunsul, in cazul in care login-ul a avut succes, deschidem un thread pentru comenzi
...
//Thread pentru posibilitatea comunicarii intre multiplii clienti si server, deodata.
    ...
    public void handleMessage(String[] tokensMsg) throws Exception {
